...
<div class="vh-model-detail" data-vh-model-detail data-model-type="asr_granite_speech" data-task="automatic-speech-recognition" data-training="native" data-parameter-count="2313141596" markdown>

<header class="vh-model-detail__hero" data-vh-model-hero markdown>

<p class="vh-model-detail__namespace" aria-label="Model repository"><span class="vh-model-detail__owner-avatar" aria-hidden="true">IG</span><a href="https://huggingface.co/ibm-granite">ibm-granite</a><span aria-hidden="true">/</span><strong>granite-speech-4.1-2b</strong></p>
...
<button class="vh-model-detail__action vh-model-detail__copy" type="button" data-vh-copy-model-id data-model-id="ibm-granite/granite-speech-4.1-2b" aria-describedby="vh-model-checkpoint-asr_granite_speech"><span data-vh-copy-model-id-label>Copy model ID</span></button>
<a class="vh-model-detail__action" href="https://huggingface.co/ibm-granite/granite-speech-4.1-2b" data-vh-model-action="checkpoint">Checkpoint</a>
...
<aside class="vh-model-detail__sidebar" data-vh-model-facts aria-labelledby="vh-model-facts-title-asr_granite_speech"><h2 id="vh-model-facts-title-asr_granite_speech">Model facts</h2><details class="vh-model-detail__facts-disclosure" data-vh-model-facts-disclosure aria-labelledby="vh-model-facts-title-asr_granite_speech" open><summary><span>Toggle model facts</span></summary><dl class="vh-model-detail__facts"><div><dt>Task</dt><dd>Automatic speech recognition</dd></div><div><dt>Parameters</dt><dd aria-describedby="vh-model-parameters-note-asr_granite_speech">2.3B</dd></div><div><dt>Architecture</dt><dd><code>granite-speech</code></dd></div><div><dt>Runtime</dt><dd>VoiceHub-native</dd></div><div><dt>Languages</dt><dd><details class="vh-model-detail__languages"><summary>6 documented codes</summary><span><code>en</code> <code>fr</code> <code>de</code> <code>es</code> <code>pt</code> <code>ja</code></span></details></dd></div><div><dt>Capabilities</dt><dd><details class="vh-model-detail__capabilities"><summary>9 capabilities</summary><span><code>automatic-speech-recognition</code> <code>multilingual</code> <code>hotwords</code> <code>translation</code> <code>safetensors</code> <code>fine-tuning</code> <code>lora</code> <code>voicehub-native</code> <code>native-runtime</code></span></details></dd></div><div><dt>Training</dt><dd><code>native</code></dd></div><div><dt>License</dt><dd>Checkpoint-specific</dd></div><div><dt>Default checkpoint</dt><dd id="vh-model-checkpoint-asr_granite_speech"><a href="https://huggingface.co/ibm-granite/granite-speech-4.1-2b"><code>ibm-granite/granite-speech-4.1-2b</code></a></dd></div></dl></details></aside>
...
- `model_type` — Canonical model type; use 'asr_granite_speech'.
- `config` — Optional preloaded GraniteSpeechASRConfig instance.
