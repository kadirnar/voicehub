...
<option value="not-text-conditioned">Language-neutral (VAD)</option>
        ...
        <div class="vh-model-filter-field">
        <label for="vh-model-task">Model type</label>
...
<option value="voice-activity-detection">Voice activity detection (11)</option>
        ...
        <div class="vh-model-filter-field">
        <label for="vh-model-parameters">Parameters</label>
        <select id="vh-model-parameters" name="parameters" data-vh-model-select>
          <option value="">Any model size</option>
<option value="weightless">Weightless (2)</option>
<option value="under-100m">Under 100M (5)</option>
<option value="100m-499m">100M–499M (9)</option>
<option value="500m-999m">500M–999M (9)</option>
<option value="1b-2.9b">1B–2.9B (12)</option>
<option value="3b-plus">3B or more (6)</option>
<option value="not-reported">Not reported (25)</option>
        </select>
      </div>
        <div class="vh-model-filter-field">
...
<label class="vh-model-filter-chip" for="vh-model-resource-huggingface">
  ...
  <div class="vh-model-results" data-vh-model-results><article class="vh-model-card"
      ...
      data-parameter-count="0"
      data-parameter-band="weightless"
      ...
      data-resources=""
      data-search="AuditokVAD vad_auditok Voice activity detection VAD energy-vad auditok-energy-vad  Inference only Local or caller-provided Checkpoint-specific Weightless">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          ...
          <span class="vh-model-card__parameters"
            title="0 parameters. Weightless algorithm; the registered default has no model parameters."
            aria-label="0 parameters. Weightless algorithm; the registered default has no model parameters.">Weightless</span>
        </div>
...
<article class="vh-model-card"
      ...
      data-parameter-band="not-reported"
      ...
      data-search="Bark bark Text to speech TTS bark suno/bark-small suno/bark-small Prepared-data training Hugging Face Checkpoint-specific Not reported">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
      ...
      <dl class="vh-model-card__metadata">
        ...
        <div><dt>Languages</dt><dd class="vh-model-card__languages"><code>de</code><code>en</code><code>es</code><span class="vh-model-card__more-languages">+10</span></dd></div>
      </dl>
...
<article class="vh-model-card"
      ...
      data-task="text-to-speech"
      data-parameter-count="797762633"
      data-parameter-band="500m-999m"
      ...
      data-resources="notebook huggingface"
      data-search="Chatterbox chatterbox Text to speech TTS chatterbox ResembleAI/chatterbox ResembleAI/chatterbox Custom training Hugging Face Checkpoint-specific 797.8M">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
            title="797,762,633 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded."
            aria-label="797,762,633 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded.">797.8M</span>
        </div>
      ...
      <dl class="vh-model-card__metadata">
        ...
        <div><dt>Languages</dt><dd class="vh-model-card__languages"><code>ar</code><code>da</code><code>de</code><span class="vh-model-card__more-languages">+20</span></dd></div>
      </dl>
...
<article class="vh-model-card"
      ...
      data-parameter-count="2047822080"
      data-parameter-band="1b-2.9b"
      ...
      data-resources="notebook huggingface"
      data-search="Cohere asr_cohere Automatic speech recognition ASR cohere-asr CohereLabs/cohere-transcribe-03-2026 CohereLabs/cohere-transcribe-03-2026 Native training Hugging Face Checkpoint-specific 2B">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--asr">ASR</span>
          <span class="vh-model-card__parameters"
            title="2,047,822,080 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded."
            aria-label="2,047,822,080 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded.">2B</span>
        </div>
      ...
      <dl class="vh-model-card__metadata">
        ...
        <div><dt>Languages</dt><dd class="vh-model-card__languages"><code>ar</code><code>de</code><code>el</code><span class="vh-model-card__more-languages">+11</span></dd></div>
      </dl>
...
<article class="vh-model-card"
      ...
      data-resources="notebook huggingface"
      data-search="ConversationTTS conversationtts Text to speech TTS conversationtts AudioFoundation/SpeechFoundation AudioFoundation/SpeechFoundation Native training Hugging Face Non-commercial Not reported">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
...
<article class="vh-model-card"
      ...
      data-task="text-to-speech"
      data-parameter-count="859185455"
      data-parameter-band="500m-999m"
      data-training="custom"
      data-training-rank="2"
      data-checkpoint="huggingface"
      ...
      data-resources="notebook huggingface"
      data-search="CosyVoice cosyvoice Text to speech TTS cosyvoice-native FunAudioLLM/Fun-CosyVoice3-0.5B-2512 FunAudioLLM/Fun-CosyVoice3-0.5B-2512 Custom training Hugging Face Checkpoint-specific 859.2M">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
            title="859,185,455 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded."
            aria-label="859,185,455 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded.">859.2M</span>
        </div>
        <span class="vh-model-card__training">Custom training</span>
      </div>
      <div class="vh-model-card__heading">
      ...
      <dl class="vh-model-card__metadata">
        ...
        <div><dt>Languages</dt><dd class="vh-model-card__languages"><code>zh</code><code>en</code><code>ja</code><span class="vh-model-card__more-languages">+6</span></dd></div>
      </dl>
      <div class="vh-model-card__features" aria-label="Capabilities"><span>Voice cloning</span></div>
...
<article class="vh-model-card"
      ...
      data-model-type="csm"
      data-task="text-to-speech"
      data-parameter-count="1552791552"
      data-parameter-band="1b-2.9b"
      data-training="native"
      data-training-rank="0"
      data-checkpoint="huggingface"
      ...
      data-resources="notebook huggingface"
      data-search="CSM csm Text to speech TTS csm sesame/csm-1b sesame/csm-1b Native training Hugging Face Checkpoint-specific 1.6B">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
            title="1,552,791,552 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded."
            aria-label="1,552,791,552 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded.">1.6B</span>
        </div>
        <span class="vh-model-card__training">Native training</span>
      </div>
      <div class="vh-model-card__heading">
...
<article class="vh-model-card"
      ...
      data-model-type="dia"
      data-task="text-to-speech"
      data-parameter-count="1611160576"
      data-parameter-band="1b-2.9b"
      data-training="native"
      data-training-rank="0"
      data-checkpoint="huggingface"
      ...
      data-resources="notebook huggingface"
      data-search="Dia dia Text to speech TTS dia nari-labs/Dia-1.6B-0626 nari-labs/Dia-1.6B-0626 Native training Hugging Face Checkpoint-specific 1.6B">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
            title="1,611,160,576 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded."
            aria-label="1,611,160,576 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded.">1.6B</span>
        </div>
        <span class="vh-model-card__training">Native training</span>
      </div>
      <div class="vh-model-card__heading">
...
<article class="vh-model-card"
      ...
      data-resources="notebook huggingface"
      data-search="EchoTTS echo Text to speech TTS echo-dit jordand/echo-tts-base jordand/echo-tts-base Prepared-data training Hugging Face Checkpoint-specific Not reported">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
...
<article class="vh-model-card"
      ...
      data-task="text-to-speech"
      data-parameter-count="337096804"
      data-parameter-band="100m-499m"
      data-training="preprocessed"
      data-training-rank="1"
      data-checkpoint="local"
      data-license="checkpoint-specific"
      ...
      data-search="F5TTS f5tts Text to speech TTS f5tts F5TTS_v1_Base SWivid/F5-TTS Prepared-data training Local or caller-provided Checkpoint-specific 337.1M">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
            title="337,096,804 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded."
            aria-label="337,096,804 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded.">337.1M</span>
        </div>
        <span class="vh-model-card__training">Prepared-data training</span>
      </div>
      <div class="vh-model-card__heading">
...
<article class="vh-model-card"
      ...
      data-task="automatic-speech-recognition"
      data-parameter-count="241734912"
      data-parameter-band="100m-499m"
      data-training="native"
      data-training-rank="0"
      data-checkpoint="huggingface"
      ...
      data-resources="notebook huggingface"
      data-search="FasterWhisper asr_faster_whisper Automatic speech recognition ASR whisper openai/whisper-small openai/whisper-small Native training Hugging Face Checkpoint-specific 241.7M">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--asr">ASR</span>
          <span class="vh-model-card__parameters"
            title="241,734,912 parameters. Exact Safetensors total reported by the Hugging Face model API for the registered default checkpoint, retrieved 2026-08-13."
            aria-label="241,734,912 parameters. Exact Safetensors total reported by the Hugging Face model API for the registered default checkpoint, retrieved 2026-08-13.">241.7M</span>
        </div>
        <span class="vh-model-card__training">Native training</span>
      </div>
      <div class="vh-model-card__heading">
      ...
      <dl class="vh-model-card__metadata">
        ...
        <div><dt>Languages</dt><dd class="vh-model-card__languages"><code>en</code><code>zh</code><code>de</code><span class="vh-model-card__more-languages">+96</span></dd></div>
      </dl>
...
<article class="vh-model-card"
      ...
      data-task="text-to-speech"
      data-parameter-count="4561852416"
      data-parameter-band="3b-plus"
      data-training="preprocessed"
      data-training-rank="1"
      data-checkpoint="huggingface"
      data-license="noncommercial"
      ...
      data-resources="notebook huggingface"
      data-search="FishTTS fishtts Text to speech TTS fish-s2 fishaudio/s2-pro fishaudio/s2-pro Prepared-data training Hugging Face Non-commercial 4.6B">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
            title="4,561,852,416 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded."
            aria-label="4,561,852,416 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded.">4.6B</span>
        </div>
        <span class="vh-model-card__training">Prepared-data training</span>
      </div>
      <div class="vh-model-card__heading">
      ...
      <dl class="vh-model-card__metadata">
        ...
        <div><dt>Languages</dt><dd class="vh-model-card__languages"><code>zh</code><code>en</code><code>ja</code><span class="vh-model-card__more-languages">+80</span></dd></div>
      </dl>
      <div class="vh-model-card__features" aria-label="Capabilities"><span>Voice cloning</span></div>
...
<article class="vh-model-card"
      ...
      data-resources="notebook huggingface"
      data-search="FunASR asr_funasr Automatic speech recognition ASR sensevoice-small FunAudioLLM/SenseVoiceSmall FunAudioLLM/SenseVoiceSmall Native training Hugging Face Checkpoint-specific Not reported">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--asr">ASR</span>
          <span class="vh-model-card__parameters"
      ...
      <dl class="vh-model-card__metadata">
        ...
        <div><dt>Languages</dt><dd class="vh-model-card__languages"><code>zh</code><code>en</code><code>ja</code><span class="vh-model-card__more-languages">+2</span></dd></div>
      </dl>
...
<article class="vh-model-card"
      ...
      data-resources="notebook huggingface"
      data-search="FunASRVAD vad_funasr Voice activity detection VAD fsmn-vad funasr/fsmn-vad funasr/fsmn-vad Native training Hugging Face Checkpoint-specific Not reported">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--vad">VAD</span>
          <span class="vh-model-card__parameters"
...
<article class="vh-model-card"
      ...
      data-task="text-to-speech"
      data-parameter-count="128916482"
      data-parameter-band="100m-499m"
      data-training="preprocessed"
      data-training-rank="1"
      data-checkpoint="huggingface"
      ...
      data-resources="notebook huggingface"
      data-search="GPTSoVITS gptsovits Text to speech TTS gptsovits lj1995/GPT-SoVITS lj1995/GPT-SoVITS Prepared-data training Hugging Face Checkpoint-specific 128.9M">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
            title="128,916,482 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded."
            aria-label="128,916,482 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded.">128.9M</span>
        </div>
        <span class="vh-model-card__training">Prepared-data training</span>
      </div>
      <div class="vh-model-card__heading">
...
<article class="vh-model-card"
      ...
      data-task="automatic-speech-recognition"
      data-parameter-count="2313141596"
      data-parameter-band="1b-2.9b"
      data-training="native"
      data-training-rank="0"
      data-checkpoint="huggingface"
      ...
      data-resources="notebook huggingface"
      data-search="GraniteSpeech asr_granite_speech Automatic speech recognition ASR granite-speech ibm-granite/granite-speech-4.1-2b ibm-granite/granite-speech-4.1-2b Native training Hugging Face Checkpoint-specific 2.3B">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--asr">ASR</span>
          <span class="vh-model-card__parameters"
            title="2,313,141,596 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded."
            aria-label="2,313,141,596 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded.">2.3B</span>
        </div>
        <span class="vh-model-card__training">Native training</span>
      </div>
      <div class="vh-model-card__heading">
      ...
      <dl class="vh-model-card__metadata">
        ...
        <div><dt>Languages</dt><dd class="vh-model-card__languages"><code>en</code><code>fr</code><code>de</code><span class="vh-model-card__more-languages">+3</span></dd></div>
      </dl>
...
<article class="vh-model-card"
      ...
      data-task="text-to-speech"
      data-parameter-count="5771283456"
      data-parameter-band="3b-plus"
      data-training="native"
      data-training-rank="0"
      data-checkpoint="huggingface"
      ...
      data-resources="notebook huggingface"
      data-search="HiggsTTS higgstts Text to speech TTS higgs_audio_v2 bosonai/higgs-tts-2-3b-base bosonai/higgs-tts-2-3b-base Native training Hugging Face Checkpoint-specific 5.8B">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
            title="5,771,283,456 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded."
            aria-label="5,771,283,456 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded.">5.8B</span>
        </div>
        <span class="vh-model-card__training">Native training</span>
      </div>
      <div class="vh-model-card__heading">
      ...
      <dl class="vh-model-card__metadata">
        ...
        <div><dt>Languages</dt><dd class="vh-model-card__languages"><code>en</code><code>zh</code><code>de</code><span class="vh-model-card__more-languages">+1</span></dd></div>
      </dl>
...
<article class="vh-model-card"
      ...
      data-resources="notebook huggingface"
      data-search="Hubert asr_hubert Automatic speech recognition ASR hubert facebook/hubert-large-ls960-ft facebook/hubert-large-ls960-ft Native training Hugging Face Checkpoint-specific Not reported">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--asr">ASR</span>
          <span class="vh-model-card__parameters"
...
<article class="vh-model-card"
      ...
      data-resources="notebook huggingface"
      data-search="InflectTTS inflecttts Text to speech TTS inflecttts owensong/Inflect-Micro-v2 owensong/Inflect-Micro-v2 Prepared-data training Hugging Face Checkpoint-specific Not reported">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
...
<article class="vh-model-card"
      ...
      data-task="text-to-speech"
      data-parameter-count="512049441"
      data-parameter-band="500m-999m"
      data-training="native"
      data-training-rank="0"
      data-checkpoint="huggingface"
      ...
      data-resources="notebook huggingface"
      data-search="IrodoriTTS irodoritts Text to speech TTS irodoritts-rf-dit Aratako/Irodori-TTS-500M-v3 Aratako/Irodori-TTS-500M-v3 Native training Hugging Face Checkpoint-specific 512M">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
            title="512,049,441 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded."
            aria-label="512,049,441 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded.">512M</span>
        </div>
        <span class="vh-model-card__training">Native training</span>
      </div>
      <div class="vh-model-card__heading">
...
<article class="vh-model-card"
      ...
      data-task="text-to-speech"
      data-parameter-count="81810022"
      data-parameter-band="under-100m"
      data-training="preprocessed"
      data-training-rank="1"
      data-checkpoint="huggingface"
      data-license="checkpoint-specific"
      ...
      data-resources="notebook huggingface"
      data-search="Kokoro kokoro Text to speech TTS kokoro hexgrad/Kokoro-82M hexgrad/Kokoro-82M Prepared-data training Hugging Face Checkpoint-specific 81.8M">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
            title="81,810,022 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded."
            aria-label="81,810,022 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded.">81.8M</span>
        </div>
        <span class="vh-model-card__training">Prepared-data training</span>
      </div>
      <div class="vh-model-card__heading">
      ...
      <dl class="vh-model-card__metadata">
        ...
        <div><dt>Languages</dt><dd class="vh-model-card__languages"><code>en-US</code><code>en-GB</code><code>es</code><span class="vh-model-card__more-languages">+6</span></dd></div>
      </dl>
      <div class="vh-model-card__features" aria-label="Capabilities"><span>Core speech inference</span></div>
...
<article class="vh-model-card"
      ...
      data-task="text-to-speech"
      data-parameter-count="1766950912"
      data-parameter-band="1b-2.9b"
      data-training="native"
      data-training-rank="0"
      data-checkpoint="huggingface"
      ...
      data-resources="notebook huggingface"
      data-search="Llasa llasa Text to speech TTS llasa HKUSTAudio/Llasa-1B-Multilingual HKUSTAudio/Llasa-1B-Multilingual Native training Hugging Face Non-commercial 1.8B">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
            title="1,766,950,912 parameters. Exact Safetensors total reported by the Hugging Face model API for the registered default checkpoint, retrieved 2026-08-13."
            aria-label="1,766,950,912 parameters. Exact Safetensors total reported by the Hugging Face model API for the registered default checkpoint, retrieved 2026-08-13.">1.8B</span>
        </div>
        <span class="vh-model-card__training">Native training</span>
      </div>
      <div class="vh-model-card__heading">
      ...
      <dl class="vh-model-card__metadata">
        ...
        <div><dt>Languages</dt><dd class="vh-model-card__languages"><code>zh</code><code>en</code><code>de</code><span class="vh-model-card__more-languages">+8</span></dd></div>
      </dl>
      <div class="vh-model-card__features" aria-label="Capabilities"><span>Voice cloning</span></div>
...
<article class="vh-model-card"
      ...
      data-task="automatic-speech-recognition"
      data-parameter-count="105265408"
      data-parameter-band="100m-499m"
      data-training="native"
      data-training-rank="0"
      data-checkpoint="huggingface"
      ...
      data-resources="notebook huggingface"
      data-search="MedASR asr_medasr Automatic speech recognition ASR lasr-ctc google/medasr google/medasr Native training Hugging Face Review required 105.3M">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--asr">ASR</span>
          <span class="vh-model-card__parameters"
            title="105,265,408 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native default graph; persistent BatchNorm buffers are excluded."
            aria-label="105,265,408 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native default graph; persistent BatchNorm buffers are excluded.">105.3M</span>
        </div>
        <span class="vh-model-card__training">Native training</span>
      </div>
      <div class="vh-model-card__heading">
...
<article class="vh-model-card"
      ...
      data-resources="huggingface"
      data-search="MeloTTS melotts Text to speech TTS melotts EN myshell-ai/MeloTTS-English Prepared-data training Local or caller-provided Checkpoint-specific Not reported">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
      ...
      <dl class="vh-model-card__metadata">
        ...
        <div><dt>Languages</dt><dd class="vh-model-card__languages"><code>en</code><code>fr</code><code>ja</code><span class="vh-model-card__more-languages">+3</span></dd></div>
      </dl>
      <div class="vh-model-card__features" aria-label="Capabilities"><span>Core speech inference</span></div>
...
<article class="vh-model-card"
      ...
      data-resources="notebook huggingface"
      data-search="Moonshine asr_moonshine Automatic speech recognition ASR moonshine UsefulSensors/moonshine-tiny UsefulSensors/moonshine-tiny Native training Hugging Face Checkpoint-specific 27.1M">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--asr">ASR</span>
          <span class="vh-model-card__parameters"
            title="27,092,736 parameters. Exact Safetensors total reported by the Hugging Face model API for the registered default checkpoint, retrieved 2026-08-13."
            aria-label="27,092,736 parameters. Exact Safetensors total reported by the Hugging Face model API for the registered default checkpoint, retrieved 2026-08-13.">27.1M</span>
        </div>
        <span class="vh-model-card__training">Native training</span>
      </div>
      <div class="vh-model-card__heading">
...
<article class="vh-model-card"
      ...
      data-task="text-to-speech"
      data-parameter-count="8489841664"
      data-parameter-band="3b-plus"
      data-training="native"
      data-training-rank="0"
      data-checkpoint="huggingface"
      ...
      data-resources="notebook huggingface"
      data-search="MossTTS mosstts Text to speech TTS moss-tts OpenMOSS-Team/MOSS-TTS-v1.5 OpenMOSS-Team/MOSS-TTS-v1.5 Native training Hugging Face Checkpoint-specific 8.5B">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
            title="8,489,841,664 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded."
            aria-label="8,489,841,664 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded.">8.5B</span>
        </div>
        <span class="vh-model-card__training">Native training</span>
      </div>
      <div class="vh-model-card__heading">
      ...
      <dl class="vh-model-card__metadata">
        ...
        <div><dt>Languages</dt><dd class="vh-model-card__languages"><code>zh</code><code>yue</code><code>en</code><span class="vh-model-card__more-languages">+28</span></dd></div>
      </dl>
      <div class="vh-model-card__features" aria-label="Capabilities"><span>Voice cloning</span></div>
...
<article class="vh-model-card"
      ...
      data-resources=""
      data-search="NeMoASR asr_nemo Automatic speech recognition ASR nemo-asr nvidia/nemo/stt_en_quartznet15x5  Native training Local or caller-provided Review required Not reported">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--asr">ASR</span>
          <span class="vh-model-card__parameters"
...
<article class="vh-model-card"
      ...
      data-task="automatic-speech-recognition"
      data-parameter-count="637997088"
      data-parameter-band="500m-999m"
      data-training="native"
      data-training-rank="0"
      data-checkpoint="huggingface"
      ...
      data-resources="notebook huggingface"
      data-search="Nemotron asr_nemotron Automatic speech recognition ASR nemotron-3.5-rnnt nvidia/nemotron-3.5-asr-streaming-0.6b nvidia/nemotron-3.5-asr-streaming-0.6b Native training Hugging Face Commercial use declared 638M">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--asr">ASR</span>
          <span class="vh-model-card__parameters"
            title="637,997,088 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded."
            aria-label="637,997,088 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded.">638M</span>
        </div>
        <span class="vh-model-card__training">Native training</span>
      </div>
      <div class="vh-model-card__heading">
      ...
      <dl class="vh-model-card__metadata">
        ...
        <div><dt>Languages</dt><dd class="vh-model-card__languages"><code>en-US</code><code>en-GB</code><code>es-US</code><span class="vh-model-card__more-languages">+37</span></dd></div>
      </dl>
      <div class="vh-model-card__features" aria-label="Capabilities"><span>Timestamps</span><span>Language identification</span></div>
...
<article class="vh-model-card"
      ...
      data-resources="notebook huggingface"
      data-search="NeMoVAD vad_nemo Voice activity detection VAD marblenet-vad nvidia/Frame_VAD_Multilingual_MarbleNet_v2.0 nvidia/Frame_VAD_Multilingual_MarbleNet_v2.0 Native training Hugging Face Checkpoint-specific Not reported">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--vad">VAD</span>
          <span class="vh-model-card__parameters"
...
<article class="vh-model-card"
      ...
      data-task="text-to-speech"
      data-parameter-count="236039680"
      data-parameter-band="100m-499m"
      data-training="native"
      data-training-rank="0"
      data-checkpoint="huggingface"
      ...
      data-resources="notebook huggingface"
      data-search="NeuTTS neutts Text to speech TTS neutts neuphonic/neutts-2e neuphonic/neutts-2e Native training Hugging Face Review required 236M">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
            title="236,039,680 parameters. Exact Safetensors total reported by the Hugging Face model API for the registered default checkpoint, retrieved 2026-08-13."
            aria-label="236,039,680 parameters. Exact Safetensors total reported by the Hugging Face model API for the registered default checkpoint, retrieved 2026-08-13.">236M</span>
        </div>
        <span class="vh-model-card__training">Native training</span>
      </div>
      <div class="vh-model-card__heading">
...
<article class="vh-model-card"
      ...
      data-task="text-to-speech"
      data-parameter-count="612577280"
      data-parameter-band="500m-999m"
      data-training="native"
      data-training-rank="0"
      data-checkpoint="huggingface"
      ...
      data-resources="notebook huggingface"
      data-search="OmniVoice omnivoice Text to speech TTS omnivoice k2-fsa/OmniVoice k2-fsa/OmniVoice Native training Hugging Face Checkpoint-specific 612.6M">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
            title="612,577,280 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded."
            aria-label="612,577,280 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded.">612.6M</span>
        </div>
        <span class="vh-model-card__training">Native training</span>
      </div>
      <div class="vh-model-card__heading">
      ...
      <dl class="vh-model-card__metadata">
        ...
        <div><dt>Languages</dt><dd class="vh-model-card__languages"><code>aae</code><code>aal</code><code>aao</code><span class="vh-model-card__more-languages">+643</span></dd></div>
      </dl>
      <div class="vh-model-card__features" aria-label="Capabilities"><span>Voice cloning</span><span>Voice design</span></div>
...
<article class="vh-model-card"
      ...
      data-capabilities="automatic-speech-recognition multilingual translation timestamps safetensors fine-tuning voicehub-native"
      data-resources="notebook huggingface"
      data-search="OpenAIWhisper asr_openai_whisper Automatic speech recognition ASR whisper openai/whisper-small openai/whisper-small Native training Hugging Face Checkpoint-specific 241.7M">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--asr">ASR</span>
          <span class="vh-model-card__parameters"
...
<article class="vh-model-card"
      ...
      data-resources="notebook huggingface"
      data-search="OpenVoice openvoice Text to speech TTS openvoice-v2-converter myshell-ai/OpenVoiceV2 myshell-ai/OpenVoiceV2 Custom training Hugging Face Checkpoint-specific 32.8M">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
            title="32,792,226 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded."
            aria-label="32,792,226 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded.">32.8M</span>
        </div>
        <span class="vh-model-card__training">Custom training</span>
      </div>
      <div class="vh-model-card__heading">
      ...
      <dl class="vh-model-card__metadata">
        ...
        <div><dt>Languages</dt><dd class="vh-model-card__languages"><code>en</code><code>es</code><code>fr</code><span class="vh-model-card__more-languages">+3</span></dd></div>
      </dl>
      <div class="vh-model-card__features" aria-label="Capabilities"><span>Voice cloning</span></div>
...
<article class="vh-model-card"
      ...
      data-task="text-to-speech"
      data-parameter-count="3782986752"
      data-parameter-band="3b-plus"
      data-training="native"
      data-training-rank="0"
      data-checkpoint="huggingface"
      ...
      data-resources="notebook huggingface"
      data-search="OrpheusTTS orpheustts Text to speech TTS causal-lm canopylabs/orpheus-3b-0.1-ft canopylabs/orpheus-3b-0.1-ft Native training Hugging Face Checkpoint-specific 3.8B">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
            title="3,782,986,752 parameters. Exact Safetensors total reported by the Hugging Face model API for the registered default checkpoint, retrieved 2026-08-13."
            aria-label="3,782,986,752 parameters. Exact Safetensors total reported by the Hugging Face model API for the registered default checkpoint, retrieved 2026-08-13.">3.8B</span>
        </div>
        <span class="vh-model-card__training">Native training</span>
      </div>
      <div class="vh-model-card__heading">
...
<article class="vh-model-card"
      ...
      data-task="text-to-speech"
      data-parameter-count="1248397312"
      data-parameter-band="1b-2.9b"
      data-training="preprocessed"
      data-training-rank="1"
      data-checkpoint="huggingface"
      ...
      data-resources="notebook huggingface"
      data-search="OuteTTS outetts Text to speech TTS outetts OuteAI/Llama-OuteTTS-1.0-1B OuteAI/Llama-OuteTTS-1.0-1B Prepared-data training Hugging Face Non-commercial 1.2B">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
            title="1,248,397,312 parameters. Exact Safetensors total reported by the Hugging Face model API for the registered default checkpoint, retrieved 2026-08-13."
            aria-label="1,248,397,312 parameters. Exact Safetensors total reported by the Hugging Face model API for the registered default checkpoint, retrieved 2026-08-13.">1.2B</span>
        </div>
        <span class="vh-model-card__training">Prepared-data training</span>
      </div>
      <div class="vh-model-card__heading">
      ...
      <dl class="vh-model-card__metadata">
        ...
        <div><dt>Languages</dt><dd class="vh-model-card__languages"><code>en</code><code>ar</code><code>zh</code><span class="vh-model-card__more-languages">+20</span></dd></div>
      </dl>
      <div class="vh-model-card__features" aria-label="Capabilities"><span>Voice cloning</span></div>
...
<article class="vh-model-card"
      ...
      data-task="automatic-speech-recognition"
      data-parameter-count="627008134"
      data-parameter-band="500m-999m"
      data-training="native"
      data-training-rank="0"
      data-checkpoint="huggingface"
      ...
      data-resources="notebook huggingface"
      data-search="ParakeetTDT asr_parakeet_tdt Automatic speech recognition ASR parakeet-tdt nvidia/parakeet-tdt-0.6b-v3 nvidia/parakeet-tdt-0.6b-v3 Native training Hugging Face Commercial use declared 627M">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--asr">ASR</span>
          <span class="vh-model-card__parameters"
            title="627,008,134 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded."
            aria-label="627,008,134 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded.">627M</span>
        </div>
        <span class="vh-model-card__training">Native training</span>
      </div>
      <div class="vh-model-card__heading">
      ...
      <dl class="vh-model-card__metadata">
        ...
        <div><dt>Languages</dt><dd class="vh-model-card__languages"><code>en</code><code>es</code><code>fr</code><span class="vh-model-card__more-languages">+22</span></dd></div>
      </dl>
...
<article class="vh-model-card"
      ...
      data-task="text-to-speech"
      data-parameter-count="877842290"
      data-parameter-band="500m-999m"
      data-training="native"
      data-training-rank="0"
      data-checkpoint="huggingface"
      ...
      data-resources="notebook huggingface"
      data-search="ParlerTTS parlertts Text to speech TTS parlertts parler-tts/parler-tts-mini-v1 parler-tts/parler-tts-mini-v1 Native training Hugging Face Checkpoint-specific 877.8M">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
            title="877,842,290 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded."
            aria-label="877,842,290 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded.">877.8M</span>
        </div>
        <span class="vh-model-card__training">Native training</span>
      </div>
      <div class="vh-model-card__heading">
...
<article class="vh-model-card"
      ...
      data-resources="notebook huggingface"
      data-search="PyannoteBrouhahaVAD vad_pyannote_brouhaha Voice activity detection VAD pyannet pyannote/brouhaha pyannote/brouhaha Native training Hugging Face Checkpoint-specific Not reported">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--vad">VAD</span>
          <span class="vh-model-card__parameters"
...
<article class="vh-model-card"
      ...
      data-resources="notebook huggingface"
      data-search="PyannoteSegmentationVAD vad_pyannote_segmentation Voice activity detection VAD pyannet pyannote/segmentation-3.0 pyannote/segmentation-3.0 Native training Hugging Face Checkpoint-specific Not reported">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--vad">VAD</span>
          <span class="vh-model-card__parameters"
...
<article class="vh-model-card"
      ...
      data-resources="notebook huggingface"
      data-search="PyannoteVAD vad_pyannote Voice activity detection VAD pyannet pyannote/voice-activity-detection pyannote/voice-activity-detection Native training Hugging Face Checkpoint-specific Not reported">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--vad">VAD</span>
          <span class="vh-model-card__parameters"
...
<article class="vh-model-card"
      ...
      data-task="automatic-speech-recognition"
      data-parameter-count="938008576"
      data-parameter-band="500m-999m"
      data-training="native"
      data-training-rank="0"
      data-checkpoint="huggingface"
      ...
      data-resources="notebook huggingface"
      data-search="Qwen3ASR asr_qwen3 Automatic speech recognition ASR qwen3-asr Qwen/Qwen3-ASR-0.6B Qwen/Qwen3-ASR-0.6B Native training Hugging Face Checkpoint-specific 938M">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--asr">ASR</span>
          <span class="vh-model-card__parameters"
            title="938,008,576 parameters. Exact serialized tensor-element total from VoiceHub&#x27;s audited native primary checkpoint; a distinct learned-parameter total is not available."
            aria-label="938,008,576 parameters. Exact serialized tensor-element total from VoiceHub&#x27;s audited native primary checkpoint; a distinct learned-parameter total is not available.">938M</span>
        </div>
        <span class="vh-model-card__training">Native training</span>
      </div>
      <div class="vh-model-card__heading">
      ...
      <dl class="vh-model-card__metadata">
        ...
        <div><dt>Languages</dt><dd class="vh-model-card__languages"><code>ar</code><code>yue</code><code>zh</code><span class="vh-model-card__more-languages">+27</span></dd></div>
      </dl>
      <div class="vh-model-card__features" aria-label="Capabilities"><span>Long-form audio</span><span>Language identification</span><span class="vh-model-card__more-features">+1 more</span></div>
...
<article class="vh-model-card"
      ...
      data-task="text-to-speech"
      data-parameter-count="1916676352"
      data-parameter-band="1b-2.9b"
      data-training="preprocessed"
      data-training-rank="1"
      data-checkpoint="huggingface"
      ...
      data-resources="notebook huggingface"
      data-search="Qwen3TTS qwen3tts Text to speech TTS qwen3-tts Qwen/Qwen3-TTS-12Hz-1.7B-CustomVoice Qwen/Qwen3-TTS-12Hz-1.7B-CustomVoice Prepared-data training Hugging Face Checkpoint-specific 1.9B">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
            title="1,916,676,352 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded."
            aria-label="1,916,676,352 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded.">1.9B</span>
        </div>
        <span class="vh-model-card__training">Prepared-data training</span>
      </div>
      <div class="vh-model-card__heading">
      ...
      <dl class="vh-model-card__metadata">
        ...
        <div><dt>Languages</dt><dd class="vh-model-card__languages"><code>zh</code><code>en</code><code>ja</code><span class="vh-model-card__more-languages">+7</span></dd></div>
      </dl>
      <div class="vh-model-card__features" aria-label="Capabilities"><span>Voice cloning</span><span>Voice design</span></div>
...
<article class="vh-model-card"
      ...
      data-task="automatic-speech-recognition"
      data-parameter-count="1501842240"
      data-parameter-band="1b-2.9b"
      data-training="native"
      data-training-rank="0"
      data-checkpoint="huggingface"
      ...
      data-resources="notebook huggingface"
      data-search="SeamlessM4Tv2 asr_seamless_m4t_v2 Automatic speech recognition ASR seamless-m4t-v2-s2t facebook/seamless-m4t-v2-large facebook/seamless-m4t-v2-large Native training Hugging Face Non-commercial 1.5B">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--asr">ASR</span>
          <span class="vh-model-card__parameters"
            title="1,501,842,240 parameters. Exact parameter total for the speech-to-text subset loaded from VoiceHub&#x27;s audited unified default checkpoint."
            aria-label="1,501,842,240 parameters. Exact parameter total for the speech-to-text subset loaded from VoiceHub&#x27;s audited unified default checkpoint.">1.5B</span>
        </div>
        <span class="vh-model-card__training">Native training</span>
      </div>
      <div class="vh-model-card__heading">
      ...
      <dl class="vh-model-card__metadata">
        ...
        <div><dt>Languages</dt><dd class="vh-model-card__languages"><code>afr</code><code>amh</code><code>arb</code><span class="vh-model-card__more-languages">+95</span></dd></div>
      </dl>
      <div class="vh-model-card__features" aria-label="Capabilities"><span>Core speech inference</span></div>
...
<article class="vh-model-card"
      ...
      data-resources="notebook huggingface"
      data-search="SherpaONNXVAD vad_sherpa_onnx Voice activity detection VAD native-vad-dispatch safestack/silero-vad safestack/silero-vad Native training Hugging Face Review required Not reported">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--vad">VAD</span>
          <span class="vh-model-card__parameters"
...
<article class="vh-model-card"
      ...
      data-resources="notebook huggingface"
      data-search="SileroVAD vad_silero Voice activity detection VAD silero-vad safestack/silero-vad safestack/silero-vad Native training Hugging Face Checkpoint-specific Not reported">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--vad">VAD</span>
          <span class="vh-model-card__parameters"
...
<article class="vh-model-card"
      ...
      data-resources="notebook huggingface"
      data-search="SpeechBrainASR asr_speechbrain Automatic speech recognition ASR speechbrain-crdnn-asr speechbrain/asr-crdnn-rnnlm-librispeech speechbrain/asr-crdnn-rnnlm-librispeech Native training Hugging Face Commercial use declared Not reported">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--asr">ASR</span>
          <span class="vh-model-card__parameters"
...
<article class="vh-model-card"
      ...
      data-resources="notebook huggingface"
      data-search="SpeechBrainVAD vad_speechbrain Voice activity detection VAD speechbrain-crdnn-vad speechbrain/vad-crdnn-libriparty speechbrain/vad-crdnn-libriparty Native training Hugging Face Checkpoint-specific Not reported">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--vad">VAD</span>
          <span class="vh-model-card__parameters"
...
<article class="vh-model-card"
      ...
      data-resources="notebook huggingface"
      data-search="SpeechT5 speecht5 Text to speech TTS speecht5 microsoft/speecht5_tts microsoft/speecht5_tts Native training Hugging Face Checkpoint-specific Not reported">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
...
<article class="vh-model-card"
      ...
      data-resources="huggingface"
      data-search="StyleTTS2 styletts2 Text to speech TTS styletts2  yl4579/StyleTTS2-LibriTTS Prepared-data training Local or caller-provided Checkpoint-specific Not reported">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
...
<article class="vh-model-card"
      ...
      data-resources="notebook huggingface"
      data-search="Supertonic supertonic Text to speech TTS supertonic Supertone/supertonic-3 Supertone/supertonic-3 Prepared-data training Hugging Face Checkpoint-specific Not reported">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
      ...
      <dl class="vh-model-card__metadata">
        ...
        <div><dt>Languages</dt><dd class="vh-model-card__languages"><code>en</code><code>ko</code><code>ja</code><span class="vh-model-card__more-languages">+28</span></dd></div>
      </dl>
      <div class="vh-model-card__features" aria-label="Capabilities"><span>Core speech inference</span></div>
...
<article class="vh-model-card"
      ...
      data-task="automatic-speech-recognition"
      data-parameter-count="1543539200"
      data-parameter-band="1b-2.9b"
      data-training="native"
      data-training-rank="0"
      data-checkpoint="huggingface"
      ...
      data-resources="notebook huggingface"
      data-search="Tiron asr_tiron Automatic speech recognition ASR whisper Trelis/tiron Trelis/tiron Native training Hugging Face Checkpoint-specific 1.5B">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--asr">ASR</span>
          <span class="vh-model-card__parameters"
            title="1,543,539,200 parameters. Exact Safetensors total reported by the Hugging Face model API for the registered default checkpoint, retrieved 2026-08-13."
            aria-label="1,543,539,200 parameters. Exact Safetensors total reported by the Hugging Face model API for the registered default checkpoint, retrieved 2026-08-13.">1.5B</span>
        </div>
        <span class="vh-model-card__training">Native training</span>
      </div>
      <div class="vh-model-card__heading">
...
<article class="vh-model-card"
      ...
      data-resources="notebook huggingface"
      data-search="TransformersASR asr_transformers Automatic speech recognition ASR native-asr-dispatch openai/whisper-small openai/whisper-small Native training Hugging Face Checkpoint-specific 241.7M">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--asr">ASR</span>
          <span class="vh-model-card__parameters"
...
<article class="vh-model-card"
      ...
      data-resources=""
      data-search="TransformersVAD vad_transformers Voice activity detection VAD wav2vec2   Native training Local or caller-provided Checkpoint-specific Not reported">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--vad">VAD</span>
          <span class="vh-model-card__parameters"
...
<article class="vh-model-card"
      ...
      data-task="automatic-speech-recognition"
      data-parameter-count="8330325888"
      data-parameter-band="3b-plus"
      data-training="native"
      data-training-rank="0"
      data-checkpoint="huggingface"
      ...
      data-resources="notebook huggingface"
      data-search="VibeVoice asr_vibevoice Automatic speech recognition ASR vibevoice-asr microsoft/VibeVoice-ASR-HF microsoft/VibeVoice-ASR-HF Native training Hugging Face Checkpoint-specific 8.3B">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--asr">ASR</span>
          <span class="vh-model-card__parameters"
            title="8,330,325,888 parameters. Exact serialized tensor-element total from VoiceHub&#x27;s audited native primary checkpoint; a distinct learned-parameter total is not available."
            aria-label="8,330,325,888 parameters. Exact serialized tensor-element total from VoiceHub&#x27;s audited native primary checkpoint; a distinct learned-parameter total is not available.">8.3B</span>
        </div>
        <span class="vh-model-card__training">Native training</span>
      </div>
      <div class="vh-model-card__heading">
      ...
      <dl class="vh-model-card__metadata">
        ...
        <div><dt>Languages</dt><dd class="vh-model-card__languages"><code>en</code><code>zh</code><code>es</code><span class="vh-model-card__more-languages">+48</span></dd></div>
      </dl>
      <div class="vh-model-card__features" aria-label="Capabilities"><span>Timestamps</span><span>Long-form audio</span><span class="vh-model-card__more-features">+2 more</span></div>
...
<article class="vh-model-card"
      ...
      data-task="text-to-speech"
      data-parameter-count="1017626724"
      data-parameter-band="1b-2.9b"
      data-training="preprocessed"
      data-training-rank="1"
      data-checkpoint="huggingface"
      ...
      data-resources="notebook huggingface"
      data-search="VibeVoice vibevoice Text to speech TTS vibevoice-tts microsoft/VibeVoice-Realtime-0.5B microsoft/VibeVoice-Realtime-0.5B Prepared-data training Hugging Face Checkpoint-specific 1B">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
            title="1,017,626,724 parameters. Exact serialized tensor-element total from VoiceHub&#x27;s audited native primary checkpoint; a distinct learned-parameter total is not available."
            aria-label="1,017,626,724 parameters. Exact serialized tensor-element total from VoiceHub&#x27;s audited native primary checkpoint; a distinct learned-parameter total is not available.">1B</span>
        </div>
        <span class="vh-model-card__training">Prepared-data training</span>
      </div>
      <div class="vh-model-card__heading">
...
<article class="vh-model-card"
      ...
      data-resources="notebook huggingface"
      data-search="Vits vits Text to speech TTS vits facebook/mms-tts-eng facebook/mms-tts-eng Prepared-data training Hugging Face Checkpoint-specific 36.3M">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
            title="36,284,592 parameters. Exact Safetensors total reported by the Hugging Face model API for the registered default checkpoint, retrieved 2026-08-13."
            aria-label="36,284,592 parameters. Exact Safetensors total reported by the Hugging Face model API for the registered default checkpoint, retrieved 2026-08-13.">36.3M</span>
        </div>
        <span class="vh-model-card__training">Prepared-data training</span>
      </div>
      <div class="vh-model-card__heading">
...
<article class="vh-model-card"
      ...
      data-task="text-to-speech"
      data-parameter-count="2290004544"
      data-parameter-band="1b-2.9b"
      data-training="native"
      data-training-rank="0"
      data-checkpoint="huggingface"
      ...
      data-resources="notebook huggingface"
      data-search="VoxCPM voxcpm Text to speech TTS voxcpm2 openbmb/VoxCPM2 openbmb/VoxCPM2 Native training Hugging Face Checkpoint-specific 2.3B">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
            title="2,290,004,544 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded."
            aria-label="2,290,004,544 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded.">2.3B</span>
        </div>
        <span class="vh-model-card__training">Native training</span>
      </div>
      <div class="vh-model-card__heading">
      ...
      <dl class="vh-model-card__metadata">
        ...
        <div><dt>Languages</dt><dd class="vh-model-card__languages"><code>zh</code><code>en</code><code>ar</code><span class="vh-model-card__more-languages">+27</span></dd></div>
      </dl>
      <div class="vh-model-card__features" aria-label="Capabilities"><span>Voice cloning</span><span>Voice design</span></div>
...
<article class="vh-model-card"
      ...
      data-resources="huggingface"
      data-search="Vui vui Text to speech TTS vui vui-abraham-100m.pt fluxions/vui Prepared-data training Local or caller-provided Checkpoint-specific Not reported">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
...
<article class="vh-model-card"
      ...
      data-capabilities="automatic-speech-recognition timestamps safetensors fine-tuning voicehub-native"
      data-resources="notebook huggingface"
      data-search="Wav2Vec2 asr_wav2vec2 Automatic speech recognition ASR wav2vec2 facebook/wav2vec2-base-960h facebook/wav2vec2-base-960h Native training Hugging Face Checkpoint-specific 94.4M">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--asr">ASR</span>
          <span class="vh-model-card__parameters"
            title="94,395,552 parameters. Exact Safetensors total reported by the Hugging Face model API for the registered default checkpoint, retrieved 2026-08-13."
            aria-label="94,395,552 parameters. Exact Safetensors total reported by the Hugging Face model API for the registered default checkpoint, retrieved 2026-08-13.">94.4M</span>
        </div>
        <span class="vh-model-card__training">Native training</span>
      </div>
      <div class="vh-model-card__heading">
...
<article class="vh-model-card"
      ...
      data-capabilities="automatic-speech-recognition timestamps safetensors fine-tuning voicehub-native"
      data-resources="notebook huggingface"
      data-search="WavLM asr_wavlm Automatic speech recognition ASR wavlm patrickvonplaten/wavlm-libri-clean-100h-base-plus patrickvonplaten/wavlm-libri-clean-100h-base-plus Native training Hugging Face Checkpoint-specific Not reported">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--asr">ASR</span>
          <span class="vh-model-card__parameters"
...
<article class="vh-model-card"
      ...
      data-resources=""
      data-search="WebRTCVAD vad_webrtc Voice activity detection VAD webrtc-vad webrtc-vad  Inference only Local or caller-provided Checkpoint-specific Weightless">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--vad">VAD</span>
          <span class="vh-model-card__parameters"
...
<article class="vh-model-card"
      ...
      data-resources=""
      data-search="WeNetASR asr_wenet Automatic speech recognition ASR wenet-asr wenet/gigaspeech-u2pp-conformer  Native training External archive Review required Not reported">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--asr">ASR</span>
          <span class="vh-model-card__parameters"
...
<article class="vh-model-card"
      ...
      data-task="automatic-speech-recognition"
      data-parameter-count="808878080"
      data-parameter-band="500m-999m"
      data-training="native"
      data-training-rank="0"
      data-checkpoint="huggingface"
      ...
      data-capabilities="automatic-speech-recognition multilingual translation timestamps safetensors fine-tuning voicehub-native"
      data-resources="notebook huggingface"
      data-search="Whisper asr_whisper Automatic speech recognition ASR whisper openai/whisper-large-v3-turbo openai/whisper-large-v3-turbo Native training Hugging Face Checkpoint-specific 808.9M">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--asr">ASR</span>
          <span class="vh-model-card__parameters"
            title="808,878,080 parameters. Exact Safetensors total reported by the Hugging Face model API for the registered default checkpoint, retrieved 2026-08-13."
            aria-label="808,878,080 parameters. Exact Safetensors total reported by the Hugging Face model API for the registered default checkpoint, retrieved 2026-08-13.">808.9M</span>
        </div>
        <span class="vh-model-card__training">Native training</span>
      </div>
      <div class="vh-model-card__heading">
...
<article class="vh-model-card"
      ...
      data-resources="notebook huggingface"
      data-search="WhisperX asr_whisperx Automatic speech recognition ASR whisper openai/whisper-small openai/whisper-small Native training Hugging Face Checkpoint-specific 241.7M">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--asr">ASR</span>
          <span class="vh-model-card__parameters"
...
<article class="vh-model-card"
      ...
      data-task="text-to-speech"
      data-parameter-count="466874863"
      data-parameter-band="100m-499m"
      data-training="preprocessed"
      data-training-rank="1"
      data-checkpoint="huggingface"
      ...
      data-resources="notebook huggingface"
      data-search="XTTS xtts Text to speech TTS xtts2 coqui/XTTS-v2 coqui/XTTS-v2 Prepared-data training Hugging Face Review required 466.9M">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
            title="466,874,863 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded."
            aria-label="466,874,863 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded.">466.9M</span>
        </div>
        <span class="vh-model-card__training">Prepared-data training</span>
      </div>
      <div class="vh-model-card__heading">
      ...
      <dl class="vh-model-card__metadata">
        ...
        <div><dt>Languages</dt><dd class="vh-model-card__languages"><code>en</code><code>es</code><code>fr</code><span class="vh-model-card__more-languages">+14</span></dd></div>
      </dl>
      <div class="vh-model-card__features" aria-label="Capabilities"><span>Voice cloning</span></div>
...
<article class="vh-model-card"
      ...
      data-task="text-to-speech"
      data-parameter-count="1624399872"
      data-parameter-band="1b-2.9b"
      data-training="preprocessed"
      data-training-rank="1"
      data-checkpoint="huggingface"
      ...
      data-resources="notebook huggingface"
      data-search="Zonos zonos Text to speech TTS zonos Zyphra/Zonos-v0.1-transformer Zyphra/Zonos-v0.1-transformer Prepared-data training Hugging Face Checkpoint-specific 1.6B">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
            title="1,624,399,872 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded."
            aria-label="1,624,399,872 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded.">1.6B</span>
        </div>
        <span class="vh-model-card__training">Prepared-data training</span>
      </div>
      <div class="vh-model-card__heading">
      ...
      <dl class="vh-model-card__metadata">
        ...
        <div><dt>Languages</dt><dd class="vh-model-card__languages"><code>en</code><code>ja</code><code>zh</code><span class="vh-model-card__more-languages">+2</span></dd></div>
      </dl>
      <div class="vh-model-card__features" aria-label="Capabilities"><span>Voice cloning</span></div>
...
<article class="vh-model-card"
      ...
      data-task="text-to-speech"
      data-parameter-count="7668118208"
      data-parameter-band="3b-plus"
      data-training="native"
      data-training-rank="0"
      data-checkpoint="huggingface"
      ...
      data-capabilities="text-to-speech voice-cloning multilingual fine-tuning safetensors voicehub-native native-runtime"
      data-resources="notebook huggingface"
      data-search="Zonos2 zonos2 Text to speech TTS zonos2 Zyphra/ZONOS2 Zyphra/ZONOS2 Native training Hugging Face Checkpoint-specific 7.7B">
      <div class="vh-model-card__topline">
        <div class="vh-model-card__identity">
          <span class="vh-model-badge vh-model-badge--tts">TTS</span>
          <span class="vh-model-card__parameters"
            title="7,668,118,208 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded."
            aria-label="7,668,118,208 parameters. Exact learned-parameter total for VoiceHub&#x27;s audited native primary graph at the registered default selection; separately loaded auxiliary models are excluded.">7.7B</span>
        </div>
        <span class="vh-model-card__training">Native training</span>
      </div>
      <div class="vh-model-card__heading">
      ...
      <dl class="vh-model-card__metadata">
        ...
        <div><dt>Languages</dt><dd class="vh-model-card__languages"><code>en</code><code>zh</code><code>ja</code><span class="vh-model-card__more-languages">+31</span></dd></div>
      </dl>
      <div class="vh-model-card__features" aria-label="Capabilities"><span>Voice cloning</span></div>
